...
public class QuotationDailyServiceTests {
	...
	@Transactional
	@Rollback
	public void testNextMonthDailysFromForecastAnnDate() {
		ApiResponseCmd<?> respCmd = quotationDailyService.nextMonthDailysFromForecastAnnDate();
